                ...
                <div className="animate-fade-in-up sm:w-2/3" style={{ animationDelay: '0.5s' }}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2 pt-1 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
                      {/* Location pin icon */}
                      <svg className="w-5 h-5 text-cyan-400 animate-bounce-subtle" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      {/* Indian flag */}
                      <svg className="w-6 h-5 animate-wave" viewBox="0 0 225 150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Indian flag">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 font-mono">
                ...
                <div className="flex items-center gap-2 group opacity-50 hover:opacity-100 transition-opacity order-1 md:order-2">
                  ...
                  <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-white/5 border border-white/10 group-hover:border-cyan-500/30 transition-all">
                    <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Gemini logo">
                      <defs>
