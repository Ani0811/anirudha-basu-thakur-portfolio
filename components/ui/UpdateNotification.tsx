  ...
  return (
    <>
      {!showNotification && (
        ...
        >
          <svg className="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} aria-hidden="true">
            <path
              strokeLinecap="round"
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  ...
                  <svg className="h-4 w-4 group-hover/link:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} aria-hidden="true">
